...
class WithdrawCard extends Component {
    render() {
        return (
            <>
                <div class="uk-card uk-card-default uk-card-small uk-card-body mb-4">
                    <div className="">
                        <div className="row" style={rowStyle}>
                            <div className="col-s8 col-md-8 col-lg-8" style={textStlye}>
                                <h5 className="investment-title">{this.props.investmentTitle} </h5>
                                <span className="wc-title" style={hL}>Total Time Left Withdrawal </span>
                                <p style={hL}>{this.props.timeLeft}</p>
